...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'images.nullable'                  => 'Product images is required!',
            'image.nullable'                   => 'Product thumbnail is required!',
        ...
        if ($request->ajax()) {
            ...
            if ($request->hasFile('images') && count($request->file('images')) > 0) {
                ...
                // No images uploaded, set default image
                
                $defaultImageName = 'default_product.png';
                $p->images = json_encode([$defaultImageName]);
            }
        
            // Handle thumbnail image
            $thumbnailImage = $request->hasFile('image') ? ImageManager::upload('product/thumbnail/', 'png', $request->file('image')) : 'default_product.png';
            $p->thumbnail = $thumbnailImage;
