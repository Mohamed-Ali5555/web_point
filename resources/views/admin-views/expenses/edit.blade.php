    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-1 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\translate('expenses_update_form')}}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            <div class="col-md-12">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label for="value" class="title-color text-capitalize">{{ \App\CPU\translate('value')}}</label>
                                        <input type="text" name="value" class="form-control" value="{{$expense['value']}}" required>
                                    </div>
                                </div>
                ...
                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="hidden" id="id" name="id">
                                        <label for="date" class="title-color text-capitalize">{{ \App\CPU\translate('date')}}</label>
                                    ...
                                    <select
                                      ...
                                      >
                                        ...
                                        @foreach($facilites as $facilite)
                                            <option
                                                value="{{$facilite['id']}}" {{ $facilite->id==$expense->facilite_id ? 'selected' : ''}} >{{$facilite['name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
