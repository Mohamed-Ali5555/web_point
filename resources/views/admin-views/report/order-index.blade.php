...
//where('order_type','default_type')
                ...
                $data=\App\Model\Order::where(['order_status'=>'delivered'])->select(
...
//where('order_type','default_type')
                ...
                $data=\App\Model\Order::where(['order_status'=>'returned'])->select(
                \Illuminate\Support\Facades\DB::raw('COUNT(id) as count'),
                \Illuminate\Support\Facades\DB::raw('YEAR(created_at) year, MONTH(created_at) month')
                )->whereBetween('created_at', [$from, $to])->groupby('year', 'month')->get()->toArray();
...
//where('order_type','default_type')
                ...
                $data=\App\Model\Order::where(['order_status'=>'failed'])->select(
                \Illuminate\Support\Facades\DB::raw('COUNT(id) as count'),
                \Illuminate\Support\Facades\DB::raw('YEAR(created_at) year, MONTH(created_at) month')
                )->whereBetween('created_at', [$from, $to])->groupby('year', 'month')->get()->toArray();
...
//where('order_type','default_type')
                ...
                $data=\App\Model\Order::where(['order_status'=>'processing'])->select(
                \Illuminate\Support\Facades\DB::raw('COUNT(id) as count'),
                \Illuminate\Support\Facades\DB::raw('YEAR(created_at) year, MONTH(created_at) month')
                )->whereBetween('created_at', [$from, $to])->groupby('year', 'month')->get()->toArray();
