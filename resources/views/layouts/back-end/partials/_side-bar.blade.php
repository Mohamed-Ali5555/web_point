                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/expense*') || Request::is('admin/expense*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ \App\CPU\translate('administrative_expenses ') }}">
                                    <i class="tio-users-switch nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('administrative_expenses') }}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/expense*') || Request::is('admin/expense*') ? 'block' : 'none' }}">
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/coupon*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.expense.list') }}"
                                            title="{{ \App\CPU\translate('expenses') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/facilite*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.facilite.list') }}"
                                            title="{{ \App\CPU\translate('facilites') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('facilites') }}</span>
                                        </a>
                                    </li>
                                    ...
                                    {{-- report expense --}}
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/expense/report*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.expense.report') }}"
                                            title="{{ \App\CPU\translate('expense_report') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('expense_report') }}</span>
                                        </a>
                                    </li>
                                    {{-- end report expense --}}
                                    {{-- Profit reports  --}}
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/expense/profit_report*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            href="{{ route('admin.expense.profit_report') }}"
                                            title="{{ \App\CPU\translate('profit_report') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ \App\CPU\translate('profit_report') }}</span>
                                        </a>
                                    </li>
                                    {{-- end Profit reports --}}
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('system_settings'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/page*') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') ? 'active' : '' }}">
                                        <a class="nav-link"
