...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'expense', 'as' => 'expense.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'ExpenseController@add_new')->name('add-new');
            Route::post('add-new', 'ExpenseController@store')->name('store');
            Route::get('list', 'ExpenseController@list')->name('list');
            Route::get('update/{id}', 'ExpenseController@edit')->name('edit');
            Route::put('update/{id}', 'ExpenseController@update')->name('update');
            Route::post('delete', 'ExpenseController@delete')->name('delete');
            // Route::post('status-update', 'ExpenseController@status_update')->name('status-update');
            Route::get('report', 'ExpenseController@report')->name('report');

            Route::post('report_search', 'ExpenseController@report_search')->name('report_search');
            // profit_report
            Route::get('profit_report', 'ExpenseController@profit_report')->name('profit_report');
            Route::post('profit_report_search', 'ExpenseController@profit_report_search')->name('profit_report_search');
        ...
        Route::group(['prefix' => 'facilite', 'as' => 'facilite.','middleware'=>['module:product_management']], function () {
            Route::get('add-new', 'FacilitesController@add_new')->name('add-new');
            Route::post('add-new', 'FacilitesController@store')->name('store');
            Route::get('list', 'FacilitesController@list')->name('list');
            Route::get('update/{id}', 'FacilitesController@edit')->name('edit');
            Route::put('update/{id}', 'FacilitesController@update')->name('update');
            Route::post('delete', 'FacilitesController@delete')->name('delete');
            Route::post('status-update', 'FacilitesController@status_update')->name('status');
            
        });
        ////// end adminstrative expenses
